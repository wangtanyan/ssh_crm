...
<BODY>
	<FORM id=form1 name=form1
		action="${pageContext.request.contextPath }/linkMan_editLinkMan.action"
		method=post>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							<%-- <tr>
								...
								<td colspan="3"><input type="text" name="cid" style="WIDTH: 180px" value="${linkMan.customer.custName }" /></td>
							</tr> --%>
							<tr>
								<td>所属客户：</td>
								<td>
