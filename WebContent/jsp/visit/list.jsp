...
<BODY>
	<FORM id="customerForm" name="customerForm"
		action="${pageContext.request.contextPath }/linkMan_findByRequirement.action"
		method=get>
										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR style="FONT-WEIGHT: normal; FONT-STYLE: normal; BACKGROUND-COLOR: white; TEXT-DECORATION: none">
													<TD>${visit.vcustomer.custName }</TD>
													<TD>${visit.vuser.username }</TD>
													<td>${visit.vaddress }</td>
													<TD>${visit.vcontent }</TD>
													
													<TD>
													<a href="${pageContext.request.contextPath }/visit_toEditPage.action?vid=${visit.vid}">修改</a>|
													<a href="${pageContext.request.contextPath }/visit_deleteVisit.action?vid=${visit.vid}">删除</a>
													</TD>
												</TR>
