							...
							<TBODY>
								...
								<TR>
									<TD height=35 align="right">
										...
										&nbsp;&nbsp;&nbsp;&nbsp;
										<A href="<c:url value="/edit.jsp"/>" target=main><FONT color=red>修改密码</FONT></A>
										&nbsp;&nbsp;&nbsp;&nbsp;
										<A href="<c:url value="/UserAction/user_exit.action"/>" target=_top><FONT color=red>安全退出</FONT></A>
									</TD>
								</TR>
							</TBODY>
						</TABLE>
